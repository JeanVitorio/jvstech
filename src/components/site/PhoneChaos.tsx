...
export function PhoneChaos() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const bars =
        section.querySelectorAll<HTMLElement>(".chaos-bar");
       ...
       * ============================================================
       *
       * Primeiro garantimos que tudo está visível.
       * Assim, se o ScrollTrigger falhar, o conteúdo
      ...
      /*
       * Recalcula as posições depois da renderização.
       */
  ...
  return (
    ...
    >
      ...
      <div className="tech-grid pointer-events-none absolute inset-0 z-0 opacity-40" />

      <div className="pointer-events-none absolute right-0 top-1/4 z-0 h-96 w-96 rounded-full bg-accent/10 blur-[130px]" />

      <div className="pointer-events-none absolute -left-24 bottom-1/4 z-0 h-80 w-80 rounded-full bg-primary/10 blur-[130px]" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-5 text-center md:px-6">
        ...
        <div className="chaos-stage mt-12 grid grid-cols-2 gap-4 md:mt-16 md:grid-cols-4 md:gap-6">
          {screens.map((s) => (
            <div
              key={s.label}
              className="chaos-phone will-change-transform"
            >
              {/* ================================================= */}
              {/* TELEFONE */}
              {/* ================================================= */}
              ...
              <div className="relative mx-auto aspect-[9/17] w-full max-w-[170px] overflow-hidden rounded-[1.9rem] border border-primary/30 bg-[linear-gradient(170deg,oklch(0.22_0.04_235_/_95%),oklch(0.13_0.02_240_/_95%))] p-2.5 shadow-[0_30px_70px_-40px_oklch(0.72_0.16_215_/_90%)]">
                ...
                <div className="flex h-[calc(100%-1.6rem)] flex-col justify-center rounded-[1.4rem] bg-background/70 px-3 text-center">
                  ...
                  {/* Métrica */}
                  <p className="font-display text-2xl font-semibold text-brand md:text-[1.7rem]">
                    {s.metric}
                  </p>
              ...
              <p className="mt-3 font-display text-[0.72rem] font-semibold">
                {s.label}
              </p>
